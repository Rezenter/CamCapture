...
public:
     ...
     * is called. Using this function allows to send multiple commands at once to a device. When the new
     ...
     * is called. Using this function allows to send multiple modifications at once to a device. When the new
     * command does not fit inside the internal command queue any more all pending commands will be sent
     * to the device before the new one is put into the queue.
     *
     * \sa
